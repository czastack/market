...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar li > a.ajaxify').click(function (e) {
            e.preventDefault();
            App.scrollTop();
        ...
        jQuery('.page-content .ajaxify').click(function (e) {
            e.preventDefault();
            App.scrollTop();
        ...
        // 自动展开
        var menus = $('.page-sidebar-menu a[href]');
        for(var i = 0; i < menus.length; ++i){
            if(location.href.startsWith(menus[i].href)){
                var $parent = $(menus[i]).parent().addClass('active').parent();
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            href = href.substring(0, href.lastIndexOf('/') + 1) + color_ + ".css";
            $('#style_color').attr("href", href);
            if ($.cookie) {                
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            var html = '';
            var imghtml = $('.hidden .loadding').prop("outerHTML");
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'">' + imghtml + '</div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {    
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'">' + imghtml + '<span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading">' + imghtml + '&nbsp;&nbsp;<span>' + (message ? message : 'Loading...') + '</span></div>');
        },
